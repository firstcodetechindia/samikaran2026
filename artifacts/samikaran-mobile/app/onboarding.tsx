...
const SLIDES = [
  ...
  },
  {
    ...
    tag: "BUILT FOR ALL",
    title: "One Platform,\nEvery Role.",
    sub: "Students, schools, parents & partners — each with their own dedicated space.",
    accent: "#c026d3",
  ...
  },
  {
    ...
    tag: "AI PROCTORED",
    title: "Smart Exams,\nZero Cheating.",
    sub: "AI-monitored in real time — every rank here is truly earned.",
    accent: "#0284c7",
  ...
  {
    id: "3",
    tag: "RECOGNITION & REWARDS",
    title: "Earn Your Rank,\nBuild Your Future.",
    sub: "All India Rank · Merit Scholarships · Verified Certificates",
    accent: "#7c3aed",
