...
import miraAvatarImage from "@/assets/images/mira-avatar.webp";
...
export function MiraGreeting({ studentName, language, onComplete }: MiraGreetingProps) {
    ...
    >
      ...
      >
        <Button
          ...
          size="lg"
          disabled={isLoading}
          data-testid="button-start-chat-mira"
        >
          {isLoading 
